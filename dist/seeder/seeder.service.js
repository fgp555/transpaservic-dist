...
let SeederService = class SeederService {
    constructor(operatorSeederService, userSeederService, mailSeederService, orderSeederService, wablasSeederService, settingSeedService) {
    ...
    async allSeeder() {
        const operador = await this.operatorSeederService.seed();
        const user = await this.userSeederService.seed();
