...
export declare class DBInfoController {
    private readonly dbInfoService;
    constructor(dbInfoService: DBInfoService);
    getDBInfo(): Promise<{
        version: string;
        characterSet: string;
    ...
    stats(): Promise<{}>;
    dropSynchronize(request: Request): Promise<string>;
    dropSchema(request: Request): Promise<string>;
    synchronize(request: Request): Promise<string>;
