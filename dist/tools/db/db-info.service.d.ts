...
export declare class DBInfoService {
    ...
    infoConfig(): {
        ...
        cache?: boolean | {
            ...
            readonly provider?: (connection: DataSource) => import("typeorm/cache/QueryResultCache").QueryResultCache;
    ...
    stats(): Promise<{}>;
    dropSynchronize(): Promise<string>;
    dropSchema(): Promise<string>;
