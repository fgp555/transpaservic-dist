...
], UpdateAuthDto.prototype, "firstName", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'El número de WhatsApp debe ser un texto' }),
    (0, class_transformer_1.Transform)(({ value }) => value?.trim()),
    __metadata("design:type", String)
], UpdateAuthDto.prototype, "whatsapp", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'La nueva contraseña debe ser un texto' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], UpdateAuthDto.prototype, "image", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
