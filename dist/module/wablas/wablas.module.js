...
exports.WablasModule = WablasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([wabla_entity_1.WablaEntity, setting_entity_1.SettingEntity])],
        controllers: [wablas_controller_1.WablasController],
        providers: [wablas_service_1.WablasService, wablas_seeder_1.WablasSeeder, setting_service_1.SettingsService],
