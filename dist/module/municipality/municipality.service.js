...
let MunicipalityService = class MunicipalityService {
    ...
    async create(createMunicipalityDto) {
        const create = this.municipalityRepository.create(createMunicipalityDto);
        return await this.municipalityRepository.save(create);
    }
    async findAll() {
    ...
    async update(id, updateMunicipalityDto) {
