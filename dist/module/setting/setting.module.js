...
const setting_seed_1 = require("./seed/setting.seed");
...
exports.SettingModule = SettingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [setting_service_1.SettingsService, setting_seed_1.SettingSeed],
        exports: [setting_service_1.SettingsService, setting_seed_1.SettingSeed],
    })
], SettingModule);
