...
const operator_seeder_1 = require("./seed/operator.seeder");
...
exports.OperatorModule = OperatorModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([operator_entity_1.OperatorEntity, order_entity_1.OrderEntity])],
        controllers: [operator_controller_1.OperatorController],
        providers: [operator_service_1.OperatorService, operator_seeder_1.OperatorSeederService],
    })
], OperatorModule);
