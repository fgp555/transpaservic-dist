...
export declare class NotificationService {
    ...
    constructor(notificationRepository: Repository<NotificationEntity>, orderRepository: Repository<OrderEntity>, operatorRepository: Repository<OperatorEntity>, deviceRepository: Repository<DeviceEntity>);
    private expo;
